...
HD_PWD='D:/microcontroller/vivadodesign/decrement/decrement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decrement.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decrement.tcl
