...
HD_PWD='D:/microcontroller/vivadodesign/complement/complement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complement.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source complement.tcl
